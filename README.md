# Projeto de Previsão de Partidas de LoL
...
Para o uso correto do programa desenvolvido, é necessário a instalação das bibliotecas encontradas no arquivo "requirements.txt"

Essa é a publicação inicial e contém as primeiras conclusões feitas para prever corretamente os resultados das partidas do jogo "LoL". Serão feitas atualizações futuras que buscam melhorar os resultados obtidos e o desempenho dos modelos.
